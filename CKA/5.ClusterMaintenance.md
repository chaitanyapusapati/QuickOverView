...
--initial-cluster="controlplane=https://172.17.0.56:2380" --name="controlplane" --initial-advertise-peer-urls="https://172.17.0 56:2380" /
--initial-cluster-token="etcd-cluster-1" /opt/snapshot-pre-boot.db
 ```
